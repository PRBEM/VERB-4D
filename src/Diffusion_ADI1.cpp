		...
		Matrix2D<double> G, Matrix2D<double> Sources, Matrix2D<double> Losses, double dt) 
{
	...
	DiagMatrix::iterator it_B, it_A, it;
		...
		for (iy = 0; iy < y_size; iy++) {
			...
			if (ix == 0 && x_size >= 3) {
				...
				if (x_size >= 3 && y_size >= 3) {
					...
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "y_left", "x_right", x, y, Dxy, G, 0.125);
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "y_right", "x_left", x, y, Dxy, G, 0.125);
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "y_left", "x_left", x, y, Dxy, G, 0.125);
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "y_right", "x_right", x, y, Dxy, G, 0.125);

					// d/dy Dyx d/dx f
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "x_left", "y_right", x, y, Dyx, G, 0.125);
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "x_right", "y_left", x, y, Dyx, G, 0.125);
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "x_left", "y_left", x, y, Dyx, G, 0.125);
					SecondDerivativeApproximation_2D(matr_B_x, ix, iy, "x_right", "y_right", x, y, Dyx, G, 0.125);
		...
		for (iy = 0; iy < y_size; iy++) {
			...
			in = matr_A_y.index1d(iy, ix);
				...
				if (x_size >= 3 && y_size >= 3) {
					...
					// Multiplicatior = 0.125 because we approximate each term 4 times (0.25) and do it for each direction (/2)
					// d/dx Dxy d/dy f
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "y_left", "x_right", x, y, Dxy, G, 0.125);
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "y_right", "x_left", x, y, Dxy, G, 0.125);
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "y_left", "x_left", x, y, Dxy, G, 0.125);
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "y_right", "x_right", x, y, Dxy, G, 0.125);
					// d/dy Dyx d/dx f
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "x_left", "y_right", x, y, Dyx, G, 0.125);
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "x_right", "y_left", x, y, Dyx, G, 0.125);
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "x_left", "y_left", x, y, Dyx, G, 0.125);
					SecondDerivativeApproximation_2D_y(matr_B_y, ix, iy, "x_right", "y_right", x, y, Dyx, G, 0.125);
