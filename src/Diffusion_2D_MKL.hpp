...
void initialize_sparse_values(
    const Matrix2D<double>d& v_grid, const Matrix2D<double>& k_grid,
...
void initialize_rhs(std::vector<double>& rhs, const Matrix2D<double>& psd, const Matrix1D<double>& v_lower, const Matrix1D<double>& v_upper, const Matrix1D<double>& k_lower, const Matrix1D<double>& k_upper, const Matrix2D<double>d& source, double dt);
void Diffusion_2D_MKL(
    Matrix2D<double>& psd, const Matrix2D<double>d& v_grid, const Matrix2D<double>d& k_grid,
    BoundaryConditionType v_lower_type, BoundaryConditionType v_upper_type,
    BoundaryConditionType k_lower_type, BoundaryConditionType k_upper_type,
